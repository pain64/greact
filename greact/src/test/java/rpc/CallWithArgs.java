                ...
                """
                    ...
                    class Simple {
                       \s
                        ...
                        public static java.lang.Object $endpoint0_line10_col7(util.TestServer.DI x0, com.fasterxml.jackson.databind.ObjectMapper x1, java.util.List<com.fasterxml.jackson.databind.JsonNode> x2) {
                       ...
                       \s
                        ...
                        void simple() {
                            int y = 1;
                            jstack.greact.dom.Globals.doRemoteCall("/rpc", "js.Simple.$endpoint0_line10_col7", x, y);
                        }
                    }"""));
                ...
                """
                    ...
                    class Simple {
                       \s
                        @jstack.jscripter.transpiler.model.RPCEndPoint
                        @jstack.jscripter.transpiler.model.DoNotTranspile
                        public static java.lang.Object $endpoint0_line9_col7(util.TestServer.DI x0, com.fasterxml.jackson.databind.ObjectMapper x1, java.util.List<com.fasterxml.jackson.databind.JsonNode> x2) {
                            final int $closure0 = x1.treeToValue(x2.get(0), java.lang.Integer.class);
                       ...
                       \s
                        ...
                        void simple() {
                            int y = 1;
                            jstack.greact.dom.Globals.doRemoteCall("/rpc", "js.Simple.$endpoint0_line9_col7", y);
                        }
                    }"""));
