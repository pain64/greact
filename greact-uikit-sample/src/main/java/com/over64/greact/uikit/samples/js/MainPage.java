        ...
        return new div() {{
            ...
            new div() {{
                ...
                new div() {{
                    ...
                    new h4("На этsdjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjой странице предоставлена витрина основных UI элементов Greact-a") {{
                        className = "info-desc";
                    }};
                }};
            }};
